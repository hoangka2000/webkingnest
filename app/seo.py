...
BRAND_NAME = "Kingnest - Yến Sào An Thịnh Nhân"
...
DEFAULT_KEYWORDS = (
    ...
    "yến sào An Thịnh Nhân, mua yến sào, yến chưng sẵn, yến tinh chế, hộp quà yến sào"
)

PAGE_SEO: dict[str, dict[str, str]] = {
    "Trangchu.html": {
        "title": "Yến Sào An Thịnh Nhân | Kingnest - Mua yến sào chính hãng Cam Ranh",
        "description": (
            "Kingnest - Yến Sào An Thịnh Nhân chuyên yến chưng sẵn, yến tinh chế, yến thô "
    ...
    "gioi_thieu.html": {
        "title": "Giới thiệu Kingnest | Thương hiệu yến sào An Thịnh Nhân Cam Ranh",
        "description": (
            "Giới thiệu thương hiệu Yến Sào An Thịnh Nhân - Kingnest: uy tín yến sạch, "
            "quy trình chọn lọc kỹ và cam kết chất lượng tại Khánh Hòa."
        ),
        "keywords": "giới thiệu Kingnest, yến sào An Thịnh Nhân, thương hiệu yến sào Cam Ranh",
        "path": "/gioi-thieu",
        "og_type": "website",
    },
    "Tin_tuc.html": {
    ...
    "Tin_tuc_chi_tiet.html": {
        "title": "Tin tức yến sào Kingnest | Yến Sào An Thịnh Nhân",
        "description": (
            "Đọc bài viết về yến sào, sức khỏe và thương hiệu Kingnest - "
            "Yến Sào An Thịnh Nhân tại Cam Ranh."
        ),
    ...
    "Lien_he.html": {
        ...
        "description": (
            "Liên hệ Kingnest - Yến Sào An Thịnh Nhân: tư vấn sản phẩm, báo giá sỉ, "
    ...
    "Gio_hang.html": {
        "title": "Giỏ hàng | Kingnest - Yến Sào An Thịnh Nhân",
